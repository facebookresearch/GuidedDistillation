...
_RAW_COCO_PANOPTIC_SPLITS = {
    "coco_2017_unlabel_train": (
        "coco_unlabel/images/",
        "coco_unlabel/gtFine/",
        "coco_unlabel/coco_unlabel_train.json",
    ),
}


def register_all_coco_unlabel(root):
    meta = {}
    ...
    for key, (image_dir, gt_dir, gt_json) in _RAW_COCO_PANOPTIC_SPLITS.items():
        ...
        MetadataCatalog.get(key).set(
            ...
            gt_dir=gt_dir.replace("coco_unlabel_", ""),
            evaluator_type="",
            ignore_label=255,
            label_divisor=1000,
            **meta,
